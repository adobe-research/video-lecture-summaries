...
If \textit{lines} represent meaningful segments in the visual domain, sentences represent semantic units in transcripts. We further group strokes within each line into \textit{sentence strokes} using the temporal correspondence between strokes and transcript sentences. 
