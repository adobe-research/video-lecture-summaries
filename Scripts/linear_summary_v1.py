...
if __name__ == "__main__":
    ...
    figuredir = objdir + "/line_figures_v1"
    list_of_figures = Figure.getfigures(list_of_objs, line_ids, figuredir)
    
    lec.assign_figs_to_stcs(list_of_figures)
    
    html = WriteHtml(objdir + "/linear_summary_v1.html", "Linear Summary", stylesheet="../Mainpage/summaries.css")
    html.figure_script_v1(list_of_figures, lec)
    html.closehtml()
