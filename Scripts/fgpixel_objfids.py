...
def get_objects(tempdir, obj_fids, scroll_coords, objdir):
    ...
    for fids in obj_fids:
        ...
        obj_mask = pf.fgmask(img, pf.BLACK_BG_THRESHOLD, 255, True)
...
if __name__ == "__main__":    
    tempdir = sys.argv[1]
    obj_fids = read_obj_fids(sys.argv[2])
    scroll_coords = scroll.read_scroll_coord(sys.argv[3])
    objdir = sys.argv[4]
    get_objects(tempdir, obj_fids, scroll_coords, objdir)
